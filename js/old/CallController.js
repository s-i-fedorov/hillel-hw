class CallController2 {
  ...
  constructor() {
    ...
    Call.addSubscription(Call.EVENT_TYPES.changeDuration, (duration) => console.log('Current duration: ', duration));
  }
...
callController.startCall({ phone: '1111' });
